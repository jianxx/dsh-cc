Legacy snapshot of the hand-maintained parity matrix, preserved for one release cycle (see docs/plans/2026-09-03-claude-code-capability-manifest.md Phase 0 step 7). Do not edit.

/**
 * Package-owned invariant companion for `@jianxx/dsh-cc-hooks-claude-code`.
 * @module @jianxx/dsh-cc-hooks-claude-code/invariant
 */
...
const PACKAGE_NAME = '@jianxx/dsh-cc-hooks-claude-code'

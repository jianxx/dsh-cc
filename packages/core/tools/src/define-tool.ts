/**
 * Compilation of the author-facing value-schema DSL to the enforced raw JSON
 * Schema subset, plus the typed {@link defineTool} helper and its argument
 * validation. DSL types live in {@link ./schema-spec.ts}.
 * @module dsh-tools/define-tool
 */
...
import type { InferArgs, InferValue, ParameterJsonSchema, ParameterSchemaSpec, ValueSchemaSpec } from './schema-spec.ts'

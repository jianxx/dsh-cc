/**
 * Package-owned invariant companion for `@jianxx/dsh-cc-command-resume`.
 * @module @jianxx/dsh-cc-command-resume/invariant
 */
...
const PACKAGE_NAME = '@jianxx/dsh-cc-command-resume'

...
/**
 * No runtime invariant: this command adapter owns no event stream or state projection; tasks
 * rendering is a pure read over the injected jobs service, and the command registry owns
